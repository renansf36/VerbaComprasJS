...
<head>
	...
	<script language="JavaScript">
		document.write('<scr' + 'ipt src="http://172.16.63.114/VerbaComprasJS/scripts.js?versao=' + Math.random() + '?"><\/scr' + 'ipt>');
		document.write('<scr' + 'ipt src="http://172.16.63.114/VerbaComprasJS/sankhya.js?versao=' + Math.random() + '?"><\/scr' + 'ipt>');
	</script>
